...
--
-- Host: localhost    Database: db_api_appfix
-- ------------------------------------------------------
...
CREATE TABLE `tbl_producao` (
  ...
  `caminhoVideo` varchar(75) DEFAULT NULL,
  `caminhoFoto` varchar(75) DEFAULT NULL,
...
INSERT INTO `tbl_producao` VALUES (1,'','',NULL,NULL,NULL),(2,'JOAOZINHO','AVENTURAS_DE_JOAOZINHO','caminho_do_video','caminho_da_foto',1);
...
-- Dump completed on 2018-05-14 16:55:11
